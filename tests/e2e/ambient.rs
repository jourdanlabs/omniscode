...
#[tokio::test]
async fn test_ambient_runner_status() -> Result<()> {
    let _env = setup_test_env()?;
...
#[tokio::test]
async fn test_ambient_runner_trigger_and_stop() -> Result<()> {
    let _env = setup_test_env()?;
...
#[tokio::test]
async fn test_ambient_runner_queue_json() -> Result<()> {
    let _env = setup_test_env()?;
    use jcode::ambient_runner::AmbientRunnerHandle;
    use jcode::safety::SafetySystem;
...
#[tokio::test]
async fn test_ambient_runner_log_json() -> Result<()> {
    let _env = setup_test_env()?;
    use jcode::ambient_runner::AmbientRunnerHandle;
    use jcode::safety::SafetySystem;
