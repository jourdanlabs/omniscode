//! Inherited WebSocket gateway compatibility transport.
//!
...
//! OMNIS KEY V1 ships no iOS/web client and exposes no pairing or gateway
//! control command. Deferred startup does not initialize this transport.
//!
//! Architecture:
