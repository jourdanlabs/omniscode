...
//!
//! This lives in the API crate on purpose so every retained client resolves
//! `$XDG_RUNTIME_DIR` and the `~/.jcode` fallback identically. One definition
//! makes socket-selection drift impossible.
//!
