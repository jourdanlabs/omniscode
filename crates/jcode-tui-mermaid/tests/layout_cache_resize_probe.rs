...
//! 2. The synthetic cold/warm timing ratio remains above the test's conservative
//!    cache-regression threshold at the same target width.
//!
...
fn layout_cache_resize_speedup_probe() {
    ...
    assert!(
        speedup >= 3.0,
        "synthetic cold/warm cache ratio must remain at least 3.0 \
