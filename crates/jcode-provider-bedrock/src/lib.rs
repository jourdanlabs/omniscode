...
impl BedrockProvider {
    ...
    /// Bedrock Converse rejects top-level tool-input schema combinators. Preserve
    /// common object fields and widen variant branches. Deserialization remains responsible
...
mod tests {
    ...
    fn isolated_test_env() -> (EnvVarGuard, tempfile::TempDir, MutexGuard<'static, ()>) {
