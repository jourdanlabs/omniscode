    ...
    match action {
        "suggest" => {
            ...
            push_compact_discovery_kv(
                &mut content,
                "review",
                "configured catalog endpoint; receipt is not approval or availability",
                block_width,
                label_style,
                muted_style,
                MAX_DISCOVERY_DETAIL_LINES,
...
pub(crate) fn render_tool_message(
    ...
    let mut show_inline_catalog_disclosure =
    ...
    if let Some(discovery_lines) = render_discovery_card(
        ...
        is_error,
        row_width,
        show_inline_catalog_disclosure,
    ) {
        show_inline_catalog_disclosure = false;
