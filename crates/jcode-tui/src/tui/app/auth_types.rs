...
/// Account-center prompts are quarantined in Local Integrity V1. Keeping the
/// field type as `()` lets shared input routing clear an already-present value
/// without retaining any credential-bearing prompt variants.
pub(crate) type PendingAccountInput = ();
