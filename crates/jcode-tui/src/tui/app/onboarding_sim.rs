...
impl App {
    ...
    /// Move the import checkbox cursor. Only meaningful on import screens.
    ...
    /// Move the import summary pill focus (Continue / Import less) so the
    /// simulator can preview each pill's highlighted state.
