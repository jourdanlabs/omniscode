...
impl App {
    ...
    fn start_background_client_maintenance(
        ...
        if !crate::update::updates_enabled() {
            ...
            self.push_display_message(DisplayMessage::error(
                crate::update::UPDATE_DISABLED_MESSAGE,
            ));
            self.set_status_notice("Inherited updater disabled");
            return;
        }
        ...
        match action {
            crate::bus::ClientMaintenanceAction::Update => {
                crate::update::spawn_background_session_update(_session_id);
            }
            crate::bus::ClientMaintenanceAction::Rebuild => {
                ...
                crate::session_rebuild::spawn_background_session_rebuild(_session_id);
            }
        }
    }

    pub(super) fn handle_update_status(&mut self, _status: crate::bus::UpdateStatus) {
        // Inherited updater events are quarantined. They cannot advertise,
        // install, or trigger a client replacement in this distribution.
        self.background_client_action = None;
        self.pending_background_client_reload = None;
        self.remove_client_maintenance_message(crate::bus::ClientMaintenanceAction::Update);
    }
    ...
    pub(super) fn handle_session_update_status(
        &mut self,
        _status: crate::bus::SessionUpdateStatus,
    ) {
