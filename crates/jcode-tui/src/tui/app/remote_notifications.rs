...
mod tests {
    ...
    fn present_swarm_notification_formats_file_activity_with_compact_path_and_preview() {
        let presentation = present_swarm_notification(
            "moss",
            &NotificationType::FileConflict {
                path: "/home/example/project/src/tool/communicate.rs".to_string(),
            ...
            "⚠ File activity: /home/example/project/src/tool/communicate.rs - moss just edited this file you previously worked with: edited lines 323-348 (1 occurrence)",
            false,
        );
        ...
        assert_eq!(
            parsed.tldr,
            "…/project/src/tool/communicate.rs · Edited lines 323-348 (1 occurrence)"
        );
        ...
        assert_eq!(
            presentation.status_notice,
            "File activity · …/project/src/tool/communicate.rs"
        );
    }
