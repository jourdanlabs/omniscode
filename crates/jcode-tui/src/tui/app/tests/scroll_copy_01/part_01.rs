...
fn test_queued_file_activity_repaint_does_not_leave_trailing_digit_artifact() {
    ...
    app.pending_soft_interrupts = vec![
        "⚠️ File activity: /home/example/project/src/lib.rs - amber previously read this file: read lines 1-9999"
            .to_string(),
    ];
    ...
    app.pending_soft_interrupts = vec![
        "⚠️ File activity: /home/example/project/src/lib.rs - amber previously read this file: read lines 1-9"
            .to_string(),
    ];
...
fn test_notification_file_activity_repaint_does_not_leave_trailing_digit_artifact() {
    ...
    app.status_notice = Some((
        "File activity · /home/example/project/src/lib.rs · read lines 1-9999".to_string(),
    ...
    app.status_notice = Some((
        "File activity · /home/example/project/src/lib.rs · read lines 1-9".to_string(),
        std::time::Instant::now(),
    ));
    let second = render_and_snap(&app, &mut terminal);
