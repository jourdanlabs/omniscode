...
fn alt_5_resets_onboarding_sim_to_a_pristine_first_screen() {
    ...
    app.onboarding_pending_model_validation =
        Some(crate::tui::app::onboarding_flow::OnboardingPendingValidation {
...
#[test]
fn onboarding_sim_summary_arrows_preview_the_two_pills() {
