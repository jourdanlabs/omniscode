...
pub fn set_usage_telemetry_enabled(_enabled: bool) -> bool {
    false
}
...
pub fn record_discovery_event(data: DiscoveryTelemetry<'_>) {
    ...
    let event = DiscoveryEvent {
        ...
        custom_endpoint: !data.endpoint.trim().is_empty(),
        schema_version,
        build_channel,
        is_git_checkout: git_checkout,
        is_ci: ci,
...
fn show_first_run_notice() {
    // Anonymous telemetry is unavailable in OMNIS KEY Local Integrity V1.
}
